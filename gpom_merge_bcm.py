...
import time
y_pred1 = np.load("gpom_data/large_0_noise/y_pred_np1_large_5000.npy")
y_var1 = np.load("gpom_data/large_0_noise/y_var_np1_large_5000.npy")

y_pred2 = np.load("gpom_data/large_0_noise/y_pred_np2_large_5000.npy")
y_var2 = np.load("gpom_data/large_0_noise/y_var_np2_large_5000.npy")
...
end_time = time.time()
print(f"BCM fusion completed in {end_time - start_time} seconds")
# Save the merged results
np.save("gpom_data/large_0_noise/y_pred_merged_large_5000.npy", y_pred_merged)
np.save("gpom_data/large_0_noise/y_var_merged_large_5000.npy", y_var_merged)
